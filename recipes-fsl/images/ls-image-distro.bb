...
ROOTFS_POSTPROCESS_COMMAND:append = "do_fix_ldconfig; do_save_graphics; do_aptget_update; do_update_host; do_update_dns;"
IMAGE_PREPROCESS_COMMAND:append = " do_fix_connman_conflict; do_enable_graphics; do_cleanup_rootfs"

REQUIRED_DISTRO_FEATURES = ""
REQUIRED_DISTRO_FEATURES:append:ls1028a = " wayland x11"
